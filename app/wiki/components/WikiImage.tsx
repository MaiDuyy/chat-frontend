...
export function WikiImage({
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        className="max-w-[min(95vw,1400px)] p-3 bg-card border border-border rounded-lg shadow-lg"
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex w-full items-center justify-between gap-3 px-2 pb-1 text-xs font-mono">
            ...
            <a
              ...
              download
              className="px-3 py-1.5 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold transition-all duration-200 rounded-md shadow-sm active:scale-[0.98]"
            >

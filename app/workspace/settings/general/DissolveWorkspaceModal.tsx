...
export function DissolveWorkspaceModal({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md rounded-md p-0 overflow-hidden border border-border shadow-md">
        <div className="bg-red-50 p-4 flex items-center gap-3 border-b border-red-100/80">
          <div className="w-9 h-9 rounded-md bg-red-100 flex items-center justify-center text-red-600">
          ...
          <div className="space-y-3">
            <div className="flex gap-2.5 text-muted-foreground">
              ...
              <p className="text-xs leading-normal">
                Bạn đang chuẩn bị giải tán Workspace <span className="font-bold text-foreground">{workspaceName}</span>. 
            ...
            <div className="p-3 rounded-md bg-amber-50 border border-amber-100/80 text-amber-800">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-8 rounded-md border-border focus:border-red-500 font-medium text-xs"
                autoFocus
              />
            </div>
          </div>
        ...
        <DialogFooter className="p-4 bg-muted border-t border-border gap-2.5">
          <Button 
            variant="ghost" 
            onClick={onClose}
            className="rounded-md font-semibold text-muted-foreground hover:bg-muted h-8 text-xs px-3"
            disabled={isLoading}
          >
            Hủy bỏ
          </Button>
          <Button 
            ...
            className="bg-red-600 hover:bg-red-700 text-white rounded-md font-semibold h-8 text-xs shadow-none px-4 flex items-center gap-1.5"

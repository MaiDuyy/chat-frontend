...
export default function DissolveWorkspace() {
  ...
  const ImpactItem = ({ icon: Icon, label, value }: any) => (
    <div className="flex items-center gap-3 p-3 rounded-sm bg-muted dark:bg-muted/30 border border-border dark:border-white/[0.04]">
      <div className="p-1.5 rounded-sm bg-muted dark:bg-muted text-muted-foreground dark:text-zinc-350 border border-border/50">
        <Icon size={15} />
      </div>
      <div>
        <p className="text-[9px] font-bold font-mono text-muted-foreground uppercase tracking-wider">{label}</p>
      ...
      <div className="w-full max-w-2xl space-y-6">
        <div className="flex items-center gap-3">
          <Link 
            ...
            className="h-7 w-7 rounded-sm bg-background flex items-center justify-center text-muted-foreground hover:text-foreground dark:hover:text-foreground border border-border transition-colors"
          >
            <ChevronLeft size={15} />
          </Link>
        ...
        <Card className="border border-border bg-background shadow-sm overflow-hidden relative rounded-sm">
          <div className="absolute top-0 left-0 w-full h-1 bg-red-650 dark:bg-red-500" />
          <CardContent className="p-6 space-y-6">
            <div className="flex flex-col items-center text-center space-y-3">
              <div className="p-3 rounded-sm bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-900/30">
                <AlertTriangle size={30} />
              </div>
              <div className="space-y-1">
                <h2 className="text-sm font-bold font-mono uppercase tracking-wide text-foreground">Hành động này là vĩnh viễn!</h2>
                <p className="text-xs font-mono text-muted-foreground dark:text-muted-foreground max-w-md mx-auto leading-relaxed">
            ...
            <div className="p-4 rounded-sm bg-red-50/20 dark:bg-red-950/10 border border-red-200/40 dark:border-red-900/20 space-y-3">
              ...
              <Input 
                ...
                className="h-9 bg-background text-center font-bold font-mono text-sm border-red-200 dark:border-red-900/30 focus:border-red-600 dark:focus:border-red-500 focus:ring-0 rounded-sm text-red-600 dark:text-red-400 placeholder:text-red-200/60"
              />
            </div>
            ...
            <div className="flex gap-3">
              <Button 
                variant="outline" 
                className="flex-1 h-9 text-xs font-semibold font-mono text-muted-foreground rounded-sm border-border shadow-none"
                asChild
              >
              ...
              <Button 
                variant="destructive" 
                className="flex-[2] h-9 text-xs font-semibold font-mono text-white rounded-sm bg-red-650 hover:bg-red-700 dark:bg-red-950/50 dark:hover:bg-red-900/50 dark:border dark:border-red-900/40 transition-colors shadow-none"
